...
- [Python-Style-Guide](#python-style-guide)
  ...
  - [4. 类](#4-类)
    - [4.1. 字符串](#41-字符串)
    - [4.2. 文件，Sockets，以及类似的有状态的资源](#42-文件sockets以及类似的有状态的资源)
    - [4.3. TODO 注释](#43-todo-注释)
    - [4.4. 导入格式](#44-导入格式)
    - [4.5. 语句](#45-语句)
    - [4.6. Getters 与 Setters](#46-getters-与-setters)
    - [4.7. 命名](#47-命名)
    - [4.8. Main](#48-main)
    - [4.9. 函数长度](#49-函数长度)
    - [4.10. 类型注释](#410-类型注释)
...
- 如果你熟悉在 VSCode 中写代码，Python 插件可辅助你高效开发；（安装：直接在拓展中心搜索）
- pylint：代码 bug 检查；（安装：`pip install pylint`）
- autopep8：根据 [PEP-008](https://www.python.org/dev/peps/pep-0008/#other-recommendations) 中的规定格式化代码；（安装：`pip install autopep8`）

## 6. 引用参考

> [Google Python Style Guide](https://google.github.io/styleguide/pyguide.html) > [Python 风格指南中文版](https://zh-google-styleguide.readthedocs.io/en/latest/google-python-styleguide/)
